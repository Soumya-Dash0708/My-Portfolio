    ...
    <>
      ...
      >
        <div className="py-6 text-center md:px-6">
          <div className="text-3xl font-semibold uppercase tracking-wide text-primary md:text-4xl md:tracking-widest">
            Contact
          </div>
          <p className="mb-8 mt-10 max-w-xl text-sm leading-8 text-gray-500">
          ...
          <div>
            {contacts.map((contact) => (
              <div className="mt-6" key={contact.id}>
                <div className="mb-2 text-xl font-medium text-primary">
                  {contact.title}
                </div>
                <div className="text-WhiteGray text-sm text-gray-500">
                  {contact.text}
                </div>
              </div>
            ))}
        ...
        <div className="px-6 py-6 text-center shadow-ShadowBlur sm:w-[30rem] lg:w-1/2">
          <div className="mb-10 text-3xl font-semibold uppercase tracking-wide text-primary md:text-4xl md:tracking-widest">
            Contact Form
          </div>
          <form onSubmit={submitHandler}>
            ...
            <button
              type="submit"
              className="mt-10 cursor-pointer rounded-md bg-primary/10 px-8 py-4 text-sm uppercase text-primary shadow-ShadowBlur"
            >
              Send Message
            </button>
          </form>
